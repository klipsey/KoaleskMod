...
namespace KoaleskMod.KoaleskCharacter.SkillStates
{
    public class HeldState : BaseState
    {
        ...
        public override void OnEnter()
        {
            ...
            if (modelTransform)
            {
                ...
                if (component)
                {
                    ...
                    temporaryOverlayInstance.duration = 5f;
                    temporaryOverlayInstance.destroyComponentOnEnd = true;
                    temporaryOverlayInstance.originalMaterial = KoaleskAssets.heldMat;
        ...
        public override void FixedUpdate()
        {
            ...
            if (base.isAuthority && !this.HasBuff(KoaleskBuffs.koaleskDeadOfNightBuff))
            {
