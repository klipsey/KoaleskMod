...
internal enum KoaleskCameraParams
{
    DEFAULT,
    AIM_PISTOL,
    AIM_SNIPER,
...
namespace KoaleskMod.Modules
{
    internal static class CameraParams
    {
        ...
        internal static CameraTargetParams.CameraParamsOverrideHandle OverrideCameraParams(CameraTargetParams camParams, KoaleskCameraParams camera, float transitionDuration = 0.5f)
        {
        ...
        internal static CharacterCameraParams CreateCameraParamsWithData(KoaleskCameraParams camera)
        {
        ...
        internal static CharacterCameraParamsData GetNewParams(KoaleskCameraParams camera)
        {
            ...
            switch (camera)
            {
                ...
                default:
                case KoaleskCameraParams.DEFAULT:
                    paramsData = defaultCameraParams;
                    break;
                case KoaleskCameraParams.AIM_PISTOL:
                    paramsData = aimCameraParams;
                    break;
                case KoaleskCameraParams.AIM_SNIPER:
                    paramsData = sniperAimCameraParams;
                    break;
                case KoaleskCameraParams.EMOTE:
