...
namespace KoaleskMod.Modules
{
    internal static class Tokens
    {
        ...
        public const string koaleskToughPrefix = "Tough";
        ...
        public static string koaleskToughKeyword = KeywordText("Tough", "The skill cannot be interrupted and the user cannot be debuffed during the skill.");
