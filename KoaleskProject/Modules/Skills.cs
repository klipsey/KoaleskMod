...
namespace KoaleskMod.Modules
{
    internal static class Skills
    {
        ...
        public static void CreateSkillFamilies(GameObject targetPrefab, bool destroyExisting, params SkillSlot[] slots)
        {
            ...
            KoaleskPassive passive = targetPrefab.GetComponent<KoaleskPassive>();
            if (passive)
            {
            ...
            if (targetPrefab.TryGetComponent<KoaleskDarkSkills>(out var darkSkills))
            {
                darkSkills.darkPrimarySkillSlot = CreateGenericSkillWithSkillFamily(targetPrefab, "Blight Primary");
                darkSkills.darkSecondarySkillSlot = CreateGenericSkillWithSkillFamily(targetPrefab, "Blight Secondary");
                darkSkills.darkUtilitySkillSlot = CreateGenericSkillWithSkillFamily(targetPrefab, "Blight Utility");
                darkSkills.darkSpecialSkillSlot = CreateGenericSkillWithSkillFamily(targetPrefab, "Blight Special");
            }
        }
        ...
        public static void AddAdditionalSkills(SkillFamily passiveSkillFamily, params SkillDef[] skillDefs)
        {
        ...
        public static T CreateSkillDef<T>(SkillDefInfo skillDefInfo) where T : SkillDef
        {
            ...
            KoaleskMod.Modules.Content.AddSkillDef(skillDef);
        ...
        public static T CreateReloadSkillDef<T>(ReloadSkillDefInfo skillDefInfo) where T : ReloadSkillDef
        {
            ...
            KoaleskMod.Modules.Content.AddSkillDef(reloadSkillDef);
